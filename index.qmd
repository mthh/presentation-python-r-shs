...
- Un IDE avec une position quasi-hégémonique : [**RStudio**](https://posit.co/products/open-source/rstudio/) - Plus récemment, également des utilisateurs de [VS Code](https://code.visualstudio.com/)
...
- Plusieurs IDE appréciés par les utilisateurs de Python : **Spyder** (IDE "scientifique", interface comparable à RStudio),
...
- Voir les sorties HTML des notebooks [Jupyter](./notebooks/HouseSales.html) et [Rmarkdown](notebooks/house_sales.html) correspondant "House Sales in King County".
...
- [**rasterio**](https://rasterio.readthedocs.io/) (va permettre d'accéder aux données sous forme de tableau NumPy)

<br>

- [**terra**](https://rspatial.org/pkg/index.html) (I/O, *spatial prediction*, )


## Traitement automatique du langage naturel

- Python est devenu le langage le plus populaire pour la recherche et le développement d'applications TAL, en partie grâce à sa lisibilité,
...
|                                   |                              | data.table         |
+-----------------------------------+------------------------------+--------------------+
| Statistique                       | Statsmodels, Scipy           | R base             |
+-----------------------------------+------------------------------+--------------------+
...
| langue                            |                              | Tidytext           |
+-----------------------------------+------------------------------+--------------------+
| Programmation lettrée             | Jupyter notebook, Quarto     | Rmarkdown, Quarto  |
+-----------------------------------+------------------------------+--------------------+
...
- De nombreuses bibliothèques sont disponibles dans les deux langages (Selenium, Bokeh, Plotly, Tesseract, Spacy, etc.)
...
- Interopérabilité avec d'autres langages
  - R : [C/C++](https://www.rcpp.org/), [Java](https://rforge.net/rJava/), etc.
  - Python : C/C++ (plusieurs solutions), [Java](https://pyjnius.readthedocs.io/en/stable/), [Rust](https://pyo3.rs/), etc.
:::
